			...
			<div className='p-10 mx-6 rounded-2xl bg-white'>
				...
				<article className='bg-[#F8F9FE] rounded-xl'>
					...
					<section className='flex p-4 mt-4 justify-between items-center rounded-xl'>
						<div className='flex items-center'>
							<div className=''>
								<h3 className='text-2xl font-bold text-blue-900'>Arcade(Yearly)</h3>
								<NavLink
									to='/select-plan'
						...
						<div className='mx-1'>
							<span className='text-blue-900 font-bold text-xl'>$90/yr</span>
						</div>
					</section>
					...
					<section className='flex p-4 justify-between items-center'>
						...
						<div className='mx-1'>
							<span className='text-xl font-medium text-blue-900'>+$10/yr</span>
						</div>
					</section>
					...
					<section className='flex p-4 pt-0 justify-between items-center'>
						...
						<div className='mx-1'>
							<span className='text-xl font-medium text-blue-900'>+$20/yr</span>
						</div>
					</section>
				...
				<article className='mt-8'>
					<div className='flex justify-between px-2'>
						...
						<span className='text-2xl font-bold text-blue-700'>$120/yr</span>
					</div>
				</article>
			</div>
